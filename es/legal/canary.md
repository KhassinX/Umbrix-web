...
- ha recibido **cero** órdenes de silencio (gag orders) que le impidan afirmar lo anterior;
- ha recibido **cero** exigencias gubernamentales de insertar una puerta trasera, debilitar el cifrado o registrar usuarios;
- **nunca** ha entregado contenido de mensajes, metadatos de usuarios ni claves de cifrado a ninguna parte — que, por arquitectura, tampoco posee.

## Cómo funciona este canary

Esta declaración se vuelve a publicar **trimestralmente**. Si una actualización futura se retrasa, elimina una de las líneas de arriba, o esta página desaparece, debes asumir que la afirmación ausente ya no puede hacerse con verdad. No se nos puede obligar a mentir; solo se nos puede obligar a callar — y aquí el silencio es la señal.
