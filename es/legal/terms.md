...
updated: 2026-07-01
---
<!-- DRAFT — pendiente de revisión legal antes de publicar. Governing law sigue el
     template canónico (Estado de Florida); confirmación del publisher pendiente. -->
...
La app base es gratis. Si se ofrecen mejoras cosméticas de pago único o donaciones, el precio se muestra en la app antes de comprar, y las compras y reembolsos los gestiona Apple. La mensajería nunca requiere suscripción.
...
La app se proporciona "tal cual", sin garantías de ningún tipo, incluida la idoneidad para un propósito particular. Las funciones de seguridad descritas como best-effort (ver el [Informe de Transparencia](/es/legal/transparency/)) son exactamente eso. En la medida que permita la ley aplicable, KHASSINX LLC no es responsable por daños indirectos, incidentales o consecuentes derivados de tu uso de la app.
...
Estos términos se rigen por las leyes del Estado de Florida, Estados Unidos, sin atender a sus normas de conflicto de leyes.
