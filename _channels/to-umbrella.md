...
| WEB-002 | 2026-07-02 | Icon Composer: capas SVG deben ir outlined (fill), nunca stroke | Lección de Hermod (2026-07-02): un layer SVG con stroke (grillete de candado como arco stroked) renderiza en Icon Composer como slab translúcido deforme en la appearance Dark — detectado por Abraham en review visual. Fix: outlinear el path (anillo relleno, misma silueta). Candidato a: (1) sección anti-patterns de APP_ICON_DESIGN_PROCESS.md + skill design-app-icon (Fase B: 'SVGs siempre con fill, cero strokes'), (2) agente icon-composer-designer. Evidencia: Hermod/design/icon/2026-07-02-proposal/ + app/App/AppIcon.icon. | abierto |
