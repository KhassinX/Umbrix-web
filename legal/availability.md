...
<!-- Row format when a withdrawal occurs (example, not shown to readers):
| Country X | 2026-MM-DD | at the request of the local authority | <law/regulation cited> | <link, or "details restricted by law"> |
Allowed reasons: "at the request of the local authority" | "our own decision due to legal complexity". -->

**When the law restricts disclosure.** If we are legally prohibited from disclosing the details of a specific request, the affected row will read "details restricted by law" and we will publish as much as we are permitted to. Our [Warrant Canary](/legal/canary/) covers the case where we cannot speak at all.

**Reversibility.** If an authority withdraws its position, availability is restored and the row is updated with the restoration date.
